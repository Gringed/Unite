...
const Auth = (props) => {
  ...
  useEffect(() => {
    function start() {
      gapi.client.init({
        clientId:
          "978380805042-mf35omtl61pt5sg4d33d5sacptdglujm.apps.googleusercontent.com",
        scope: "email",
      });
    }
        ...
        <div className={classes.formContainer}>
          ...
          <form onSubmit={handleSubmit} id="sign-up-form">
            ...
            <div className={classes.submitContainer}>
              <GoogleLogin
                clientId="978380805042-mf35omtl61pt5sg4d33d5sacptdglujm.apps.googleusercontent.com"
                icon="true"
